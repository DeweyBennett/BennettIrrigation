...
const data = [
  ...
  },
  {
    ...
    contents: (
      <div>
        We make it easy to move to CometNine. Simply contact us and we`&lsquo;`ll move
  ...
  },
  {
    ...
    contents: (
      <div>
        ...
        contact us and we`&lsquo;`ll move your hosting account from any other provider,
        regardless of the control panel. If at anytime your website is down for
        more than 0.1% result with proper investigation experiments.
      </div>
    ),
        ...
        <section id="faq" className="pt- pt-4 pb-6">
            <div>
                ...
                <div className="text-center">
                    <button className="inline-flex items-center justify-center font-bold min-h-[50px] px-2 py-4 rounded-lg transition duration-300 ease-in-out whitespace-nowrap cursor-pointer text-text">Still Question? Contact us</button>
                </div>
            </div>
        </section>
    )
