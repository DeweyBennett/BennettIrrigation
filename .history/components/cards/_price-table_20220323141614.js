    ...
    return(
        <div className={data.is_recommended ? 'relative text-center bg-white rounded-b-lg' : 'relative text-center'}>
            ...
            >
                ...
                <button
                className={data.is_recommended ? 'inline-flex items-center justify-center font-bold min-h-[50px] px-2 py-4 rounded-lg transition duration-300 ease-in-out whitespace-nowrap cursor-pointer bg-secondary text-white hover:bg-dark' : 'binline-flex items-center justify-center border-[#FFC059] text-secondary font-bold min-h-[50px] px-2 py-4 rounded-lg transition duration-300 ease-in-out whitespace-nowrap hover:bg-secondary hover:text-white cursor-pointer'}
                >
                Choose Plan
                </button>
