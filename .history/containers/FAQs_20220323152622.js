        ...
        <section id="faq" className="pt- pt-4 pb-6">
            <div>
                ...
                <div className="text-center">
                    <button className="inline-flex items-center justify-center font-bold min-h-[50px] px-2 py-4 rounded-lg transition duration-300 ease-in-out whitespace-nowrap cursor-pointer text-te">Still Question? Contact us</button>
                </div>
            </div>
        </section>
    )
