...
export default function Header({ setIsOpen }) {
    ...
    return (
        ...
        >
            <header
                className={state.isSticky ? 'bg-white shadow-md shadow-[rgb(59,90,136)] z-0 py-3' : 'fixed left-0 right-0 py-5 bg-transparent transition-all duration-300 ease-in-out'}
            >
