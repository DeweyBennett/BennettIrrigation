            ...
            <div>
                <div className="grid grid-cols-2 gap-14 items-center min-h-[100vh] max-w-[80%] mx-auto">
                    <div className="text-left col-span-1">
                        <h1 className="text-4xl text font-extrabold text-textSecondary mb-8">
                        Bennett&apos;s Irrigation Services offers professional design, installation and repair of any and all irrigation systems
                        </h1>
