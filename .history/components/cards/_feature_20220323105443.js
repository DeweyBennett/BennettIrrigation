...
export default function Feature({ data, ...props }) {
    ...
    return (
        <div className="px-11 py-14 text-left transition duration-300 ease-in md:hover:bg-white md:border-white md:shadow-[rgb(59,90,136)] md:-translate-x-1 md:-translate-y-1" {...props}>
