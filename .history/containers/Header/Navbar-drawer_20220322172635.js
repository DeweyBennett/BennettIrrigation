...
export default function NavbarDrawer() {
    ...
    return (
        <Drawer
            ...
            placement="right"
            drawerHandler={
                <div className="flex items-center justify-center flex-shrink-0 w-[26px] cursor-pointer md:hidden">
                    <HiMenu size={40} sclassName="text-primary cursor-pointer hover" />
                </div>
            }
            open={state?.isOpen}
