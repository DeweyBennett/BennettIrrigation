...
const data = [
  {
    ...
    description: `We use the finest products available in the irrigation industry.  All parts have a one year warranty.  Total coverage is always guaranteed.`,
  },
  {
    id: 2,
    icon: 'icon2',
  ...
  },
  {
    ...
    description: `Enhance your outdoors with low voltage outdoor lighting. `,
  },
  {
    id: 6,
    icon: 'icon6',
    ...
    description: `Let us show you how we can remove the iron stains or even keep them from ever developing.`,
  },
];
